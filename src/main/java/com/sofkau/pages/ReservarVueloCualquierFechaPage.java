...
public class ReservarVueloCualquierFechaPage extends CommonActionOnPages{



    private Usuario usuario;

    public static Logger LOGGER = Logger.getLogger(ReservarVueloCualquierFechaPage.class);
    ...
    public ReservarVueloCualquierFechaPage(WebDriver driver, Usuario usuario) {
        super(driver);
